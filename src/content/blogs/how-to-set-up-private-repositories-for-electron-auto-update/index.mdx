...
seo:
  title: How to Set Up Private Repositories for Electron Auto-Update
  description: Learn how to easily enable private repository updates for Electron
    applications using electron-updater. Step-by-step guide for hassle-free setup.
  type: article
---
