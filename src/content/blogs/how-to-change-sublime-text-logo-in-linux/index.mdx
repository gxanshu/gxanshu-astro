...
seo:
  title: How To Change Sublime Text Logo in Linux (ubuntu)
  description: how to change sublime text logo in any linux system specially on ubuntu.
    step by step guide
  type: article
---
...
first of all download New [Sublime Text Icon](/images/st_icon_512.png) in any Directory. (Download folder is recommended)
