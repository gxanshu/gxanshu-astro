...
date: 2023-05-25
image: ./ttf-apple-fonts.jpg
seo:
  title: 'otf-apple-fonts: How I Created a Package to Install Apple Fonts in Arch
    Linux'
  description: Use this guide to install Apple fonts on Arch Linux. Learn how to install
    Apple fonts manually or with the AUR package otf-apple-fonts.
  type: article
---
