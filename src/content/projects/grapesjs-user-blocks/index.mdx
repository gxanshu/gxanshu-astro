...
date: 2023-07-16
image: ./grapesjs-zoom-plugin.jpg
seo:
  title: 'GrapesJS User Blocks: Create and Save Your Own Components'
  description: GrapesJS User Blocks is a plugin that allows users to create and save
    their own custom components. This makes it easy to reuse frequently used code
    snippets, and to create reusable components that can be shared with others.
  type: article
---
